...
@SpringBootTest(classes = OrderTestConfiguracion.class)
public class OrderApplicationServiceTest {
    ...
    @Test
    public void testCreateOrderWithProductPrice(){
        OrderDomainException orderDomainException = assertThrows(OrderDomainException.class,
    ...
    public void testCreateOrderWithPassiveRestaurant(){
        Restaurant restaurantResulta = Restaurant.Builder.builder()
                .restaurantId(new RestaurantId(createOrderCommand.getRestaurantId()))
                .products(List.of(new Product(new ProductId(PRODUCT_ID),"product-1",
                                new Money(new BigDecimal("50.00"))),
                        new Product(new ProductId(PRODUCT_ID),"product-2",new Money(new BigDecimal("50.00")))))
                ...
                .build();
        when(restaurantRepository.findRestaurantInformation(orderDataMapper.createOrderCommandToRestaurant(createOrderCommand)))
                .thenReturn(Optional.of(restaurantResulta));
        OrderDomainException orderDomainException = assertThrows(OrderDomainException.class,
